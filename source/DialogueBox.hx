	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		switch (PlayState.SONG.song.toLowerCase())
		{
			...
			case 'thorns':
				...
				FlxG.sound.music.fadeIn(1, 0, 0.8);
			case 'daisies':
				FlxG.sound.playMusic(Paths.music('NowLoading'), 0);
				FlxG.sound.music.fadeIn(1, 0, 0.8);
			case 'error':
				FlxG.sound.playMusic(Paths.music('NowLoading'), 0);
				FlxG.sound.music.fadeIn(1, 0, 0.8);
		...
		else if (PlayState.SONG.song.toLowerCase()=='daisies' || PlayState.SONG.song.toLowerCase()=='error' || PlayState.SONG.song.toLowerCase()=='hard-drive' || PlayState.SONG.song.toLowerCase()=='spam')
		{
			portraitLeft = new FlxSprite(-1500, 40);
			portraitLeft.frames = Paths.getSparrowAtlas('portraits/asciiPortrait', 'shared');
			portraitLeft.animation.addByPrefix('enter', 'ascii Portrait Enter instance 1', 24, false);
